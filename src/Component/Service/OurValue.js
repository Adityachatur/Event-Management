    ...
    return (
        <div>
            <div className='lg:w-11/12 mx-auto w-full flex flex-wrap lg:my-10 my-1 '>
                ...
                <div className='w-full md:w-6/12 '>
                    <h1 className='text-xl md:text-2xl lg:text-xl font-semibold p-4 text-orange-400'> - Our importance</h1>
                    <h1 className='text-2xl md:text-3xl lg:text-5xl p-4 font-bold '>Our goal is to establish genuine connections among people through the experiences of our events</h1>
                    <p className='text-lg md:text-xl lg:text-lg font-medium p-4'>
