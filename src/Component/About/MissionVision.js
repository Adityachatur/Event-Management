        ...
        <div>
            <div className='lg:w-11/12 w-full flex flex-wrap mx-auto py-10   '>
                ...
                <div className='w-full md:w-6/12 mb-5 md:mb-0'>
                    <h1 className='text-xl md:text-2xl lg:text-xl font-semibold p-4 text-orange-400 font-Orbitron'> - Think big, party even bigger.</h1>
                    ...
                    <p className='text-lg md:text-xl lg:text-lg font-medium px-4 pt-4'>
                ...
                <div className='w-full md:w-6/12 grid lg:grid-cols-2 md:grid-cols-2 gap-10 grid-cols-2 p-2'>
                    <div className='w-full md:w-[200px] lg:w-[280px] xl:w-[320px] h-[220px] bg-custom-voilet text-center space-y-2 rounded-lg mission'>
                        ...
                        <h1 className='lg:text-2xl text-xl text-white font-bold font-Orbitron'>Mission</h1>
                        <p className='text-white lg:text-base text-sm p-1 font-Onest lg:w-10/12 mx-auto'>Create an unforgettable experience that lingers in the hearts of our guests long after they depart.</p>
                    </div>
                    <div className='w-full md:w-[200px] lg:w-[280px] xl:w-[320px] h-[220px] bg-custom-voilet text-center space-y-2 rounded-lg mission'>
                        <FontAwesomeIcon icon={faEye} className='lg:text-7xl text-4xl text-white pt-3 icon' />
                        <h1 className='lg:text-2xl text-xl text-white font-bold font-Orbitron'>Vision</h1>
                        <p className='text-white lg:text-base text-sm p-1 font-Onest lg:w-10/12 mx-auto'>Create an unforgettable experience that lingers in the hearts of our guests long after they depart.</p>
                    </div>
                    <div className='w-full md:w-[200px] lg:w-[280px] xl:w-[320px] h-[220px] bg-custom-voilet text-center space-y-2 rounded-lg mission'>
                        <FontAwesomeIcon icon={faUsers} className='lg:text-7xl text-4xl text-white pt-3 icon' />
                        <h1 className='lg:text-2xl text-xl text-white font-bold font-Orbitron'>Users</h1>
                        <p className='text-white lg:text-base text-sm p-1 font-Onest lg:w-10/12 mx-auto'>Create an unforgettable experience that lingers in the hearts of our guests long after they depart.</p>
                    </div>
                    <div className='w-full md:w-[200px] lg:w-[280px] xl:w-[320px] h-[220px] bg-custom-voilet text-center space-y-2 rounded-lg mission'>
                        <FontAwesomeIcon icon={faRankingStar} className='lg:text-7xl text-4xl text-white pt-3 icon' />
                        <h1 className='lg:text-2xl text-xl text-white font-bold font-Orbitron'>Goals</h1>
                        <p className='text-white lg:text-base text-sm p-1 font-Onest lg:w-10/12 mx-auto'>Create an unforgettable experience that lingers in the hearts of our guests long after they depart.</p>
                    </div>
                </div>
            </div>
