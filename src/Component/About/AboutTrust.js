    ...
    return (
        <div>
            <div className='lg:w-11/12 mx-auto w-full flex flex-wrap lg:my-10 my-1 '>
                ...
                <div className='w-full md:w-6/12 '>
                    <h1 className='text-xl md:text-2xl lg:text-xl font-semibold p-4 text-orange-400 font-Orbitron'> - Artists showed their great creativity through their art.</h1>
                    ...
                    <p className='text-lg md:text-xl lg:text-lg font-medium px-4 pt-4 font-Roboto Serif'>
