                    ...
                    <div className='flex lg:flex-row flex-col items-center justify-center'>
                        <div className='lg:w-5/12 w-full max-w-screen-lg flex flex-col items-center lg:h-[90vh] justify-center lg:py-2 pt-10 px-5'>
                            <div className='lg:text-left text-center lg:p-2 p-0'>
                                <p className='lg:text-7xl text-3xl lg:text-left text-center font-bold font-Noto+Serif+Display text-custom-Metallic-gold' data-aos="zoom-out-right" data-aos-duration="2000">Innovative events that exceed expectations,<br /> every time <hr /></p>
